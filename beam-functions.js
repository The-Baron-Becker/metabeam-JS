...
function swapOutLightbox(nftSrc, name, data, isVideoFile) {
  ...
  const caption = `${name}<a href="${purchaseUrl}"><img src="https://uploads-ssl.webflow.com/62dec8d82ed41d0b91ac5cf1/6308a790758189efc490aaca_etherscan-logo-circle.png" alt="etherscan link" class="etherscan-link" /></a>`;
